...
<div class="modal" id="tambahMaterial<?php echo $row['id']; ?>" data-bs-backdrop="static">
    <?php
        // Title Form
        $actionName = empty($row['id'])? 'Tambah Material' :'Ubah Material'; 
        $material = '<div id="result"></div>';
    ?>
            ...
            <div class="modal-body">
                <form action="./controller/actionPengajuan.php" method="POST" class="was-validated">
                   ...
                   <div class="mb-3">
                        ...
                        <textarea class="form-control" id="materialDeskripsi" rows="3" name="materialDeskripsi" required><?php echo !empty($row['materialDeskripsi'])? $row['materialDeskripsi']:''; ?></textarea>
