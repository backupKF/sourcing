...
<table id="table-supplier<?php echo $_GET['idMaterial']?>" class="pt-2 table table-striped">
    <thead class="bg-warning">
        <tr>
            ...
            <th style="font-size:13px;width:200px" class="text-center">Feedback Doc Req</th>
                    ...
                    <div class="overflow-auto" style="height:110px">
                        ...
                        <div style="height:70px">
                            <div class="p-0">
                                ...
                                <div class="text-wrap" style="font-size:12px"><?php echo !empty($finalFeedbackRnd[0]['finalFeedbackRnd'])? $finalFeedbackRnd[0]['finalFeedbackRnd']:'-'; ?></div>
                            </div>
                        </div>
                    </div>
